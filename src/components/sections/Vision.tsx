...
export default function Vision() {
    return (
        <section id="vision" className="py-24 bg-white text-sda-blue-950">
            <div className="container mx-auto px-4 md:px-6">

                {/* Our Story / Context */}
                <div className="max-w-4xl mx-auto text-center mb-20 animate-fade-in-up">
                    <h2 className="text-4xl md:text-5xl font-serif font-bold mb-8 text-sda-blue-900">
                        Our Story: A Faithful Transition
                    </h2>
                    <p className="text-lg md:text-xl text-sda-blue-800/80 leading-relaxed mb-6">
                    ...
                    <p className="text-lg md:text-xl text-sda-blue-800/80 leading-relaxed font-medium">
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-24 max-w-5xl mx-auto">
                    ...
                    <div className="bg-slate-50 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
                        <div className="h-64 overflow-hidden relative">
                            ...
                            <div className="absolute bottom-[-20px] left-8 w-16 h-16 bg-sda-blue-100 text-sda-blue-600 rounded-full flex items-center justify-center shadow-lg z-10">
                                <Building2 className="w-8 h-8" />
                            </div>
                        </div>
                        <div className="pt-10 p-8">
                            <h3 className="text-2xl font-serif font-bold mb-4 text-sda-blue-900">For the City</h3>
                    ...
                    <div className="bg-slate-50 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
                        <div className="h-64 overflow-hidden relative">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
                            <div className="absolute bottom-[-20px] left-8 w-16 h-16 bg-sda-gold/20 text-sda-gold-600 rounded-full flex items-center justify-center shadow-lg z-10 backdrop-blur-sm bg-white/10 border border-white/20">
                                <Heart className="w-8 h-8" />
                            </div>
                        </div>
                        <div className="pt-10 p-8">
                            <h3 className="text-2xl font-serif font-bold mb-4 text-sda-blue-900">For the Ministry</h3>
                            <p className="text-gray-600 leading-relaxed">
                ...
                <div className="max-w-6xl mx-auto bg-slate-100 rounded-3xl overflow-hidden shadow-lg border border-slate-200">
                    <div className="grid md:grid-cols-2">
                        <div className="p-10 md:p-16 flex flex-col justify-center bg-sda-blue-900 text-white">
                            ...
                            <div className="flex items-center gap-3 text-sda-gold font-semibold">
                        ...
                        <div className="relative h-80 md:h-auto bg-slate-300 flex items-center justify-center group overflow-hidden">
                            ...
                            <div className="relative z-10 text-center p-6">
                                <span className="inline-block px-6 py-3 bg-white/90 backdrop-blur text-sda-blue-900 font-bold rounded-lg shadow-xl">
